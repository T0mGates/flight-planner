...
export default function FlightInfoCard({ flights, selectedId, onSelect, filters, setFilters, flightDiffs }: FlightInfoCardProps) {
  return (
    <Card className="w-full shadow-2xl border-zinc-800 bg-zinc-950/40 backdrop-blur-md text-zinc-50 rounded-xl">
      ...
      <CardHeader className="pb-3 border-b border-zinc-900">
        <FlightFiltersCard filters={filters} setFilters={setFilters} />
      </CardHeader>
            ...
            {flights.map((flight) => {
              ...
              return (
                <div
                  ...
                  className={`flex flex-col rounded-xl border transition-all cursor-pointer overflow-hidden relative ${selectedId === flight.ACID
                  ...
                  <div className="p-4 flex items-center justify-between gap-2">
                    ...
                    <div className="flex flex-col items-center justify-center min-w-30 relative">
                      ...
                      <div className="mt-2 flex flex-col items-center gap-0.5">
                        ...
                        <div className={`flex flex-col items-center border rounded px-2 py-1 transition-colors ${isDelayed ? 'bg-red-500/5 border-red-500/20' : 'bg-blue-500/5 border-blue-500/10'
                          }`}>
